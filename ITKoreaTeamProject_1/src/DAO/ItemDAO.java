...
public class ItemDAO {
	...
	public void getAllItem() {
		...
		this.allList = itemDB.selectAllItem(); //(ItemDBConnection[2]참고)
	}
	...
	public ItemDTO showOneItem() {
		...
		ItemDTO itemInform = new ItemDTO(allList.get(num)); //얕은복사
//		ItemDTO itemInform = allList.get(num); //깊은복사
	...
	public int putItemCart(ItemDTO randomItem) {
